...
import (
	...
	"microservices/cmd"
	cartMigrations "microservices/modules/cart/database/migrations"
	invoiceMigrations "microservices/modules/invoice/database/migrations"
	itemMigrations "microservices/modules/item/database/migrations"
	orderMigrations "microservices/modules/order/database/migrations"
	paymentMigrations "microservices/modules/payment/database/migrations"
