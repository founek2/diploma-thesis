...
import (
	...
	cartModule "modulith-no-db/modules/cart"
	invoiceModule "modulith-no-db/modules/invoice"
	invoiceClient "modulith-no-db/modules/invoice-client"
	orderModule "modulith-no-db/modules/order"
	paymentModule "modulith-no-db/modules/payment"
	"modulith-no-db/shared"
	"modulith-no-db/shared/middleware"
